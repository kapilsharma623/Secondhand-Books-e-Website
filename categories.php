...
<div class="categories bg-light">
  <div class="col-md-7 col-10  m-auto pt-4 ">

  <div class="input-group mb-3">
  <select class="custom-select" id="inputGroupSelect" name="thenumbers">
...
$sea="SELECT DISTINCT subject FROM allbook ORDER BY subject;";
$query=mysqli_query($conn,$sea);
while($opt=mysqli_fetch_assoc($query))
{

?>
<option value="<?php echo $opt['subject']; ?>" class="text-capitalize" id="inputGroupSelectt"><?php echo $opt['subject']; ?></option>
<?php
}
...
<div class="input-group-append">
  <button class="btn-dark" type="submit" name="search" id="searchbtn">Search</button>
  </div>
...
<script>
  $('document').ready(function(){
    $('#searchbtn').click(function(){
      var text=$('#inputGroupSelect').val();
    var add="http://localhost/bookstore/catsearch.php?cat="+text;
    window.location = add;
