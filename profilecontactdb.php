...
if($query==true)
{
    $que="UPDATE login SET phoneno='$phone',address='$address',landmark='$landmark',state='$state',city='$city',zip='$zip' WHERE login.email ='$email';";
...
if($qu==true)
{
  ...
  <script>
      ...
      window.location = 'http://localhost/bookstore/profile.php';
  </script>
<?php
}
else
